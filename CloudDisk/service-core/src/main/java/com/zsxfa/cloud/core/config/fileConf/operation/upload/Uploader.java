package com.zsxfa.cloud.core.config.fileConf.operation.upload;
...
public abstract class Uploader {
    ...
    public List<UploadFileResult> upload(HttpServletRequest httpServletRequest) {
        ...
        System.out.println("Uploader中的52行输出UploadFile: "+ uploadFile);
    ...
    public List<UploadFileResult> upload(HttpServletRequest httpServletRequest, UploadFile uploadFile) {
        ...
        try {
            ...
            System.out.println("Uploader中的74行输出UploadFile: "+ uploadFile);
            while (iter.hasNext()) {
                MultipartFile multipartFile = request.getFile(iter.next());
                System.out.println("Uploader中的74行输出MultipartFile："+multipartFile.getOriginalFilename());
