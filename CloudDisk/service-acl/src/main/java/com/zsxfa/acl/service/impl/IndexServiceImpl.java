...
import com.zsxfa.acl.service.IndexService;
...
public class IndexServiceImpl implements IndexService {
    ...
    public Map<String, Object> getUserInfo(String username) {
        ...
        //根据用户id获取角色
        List<AclRole> roleList = roleService.selectRoleByUserId(String.valueOf(user.getUserid()));
        ...
        //根据用户id获取操作权限值
        List<String> permissionValueList = permissionService.selectAclPermissionValueByUserId(String.valueOf(user.getUserid()));
    ...
    public List<JSONObject> getMenu(String username) {
        ...
        //根据用户id获取用户菜单权限
        List<JSONObject> permissionList = permissionService.selectAclPermissionByUserId(String.valueOf(user.getUserid()));
