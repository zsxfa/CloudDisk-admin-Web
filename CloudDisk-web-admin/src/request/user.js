...
// 用户登录✔
export const login = (p) => post('api/core/user/login', p)
// 获取登录状态及用户信息✔
export const checkUserLoginInfo = (p) =>
	get('api/core/user/checkuserlogininfo', p)
// 用户注册✔
export const addUser = (p) => post('api/core/user/register', p)
// 发送验证码✔
export const sendCode = (p) => get('api/sms/send/' + p)
